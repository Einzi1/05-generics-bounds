...
class FlowerTest {
    ...
    void testCreateGreenFlower() {
        assertThrows(IllegalArgumentException.class, () -> new Flower(0.5, "Rosa", "Abracadabra", PlantColor.GREEN));
    }
    ...
    void testSortFlowers() {
        ...
        flowers.add(new Shrub(3.5, "Buxus", "Buxus sempervirens"));
        flowers.add(new Flower(1.1, "Rosa", "Abracadabra", PlantColor.RED));
        flowers.add(new Shrub(5.5, "Buxus", "Buxus sempervirens"));
        flowers.add(new Flower(0.5, "Rosa", "Abracadabra", PlantColor.RED));
        flowers.add(new Shrub(1.5, "Buxus", "Buxus sempervirens"));
        flowers.add(new Flower(0.75, "Rosa", "Abracadabra", PlantColor.RED));
        flowers.add(new Shrub(4.5, "Buxus", "Buxus sempervirens"));
